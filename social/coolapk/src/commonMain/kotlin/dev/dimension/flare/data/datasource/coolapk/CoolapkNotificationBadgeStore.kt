...
/**
 * 酷安通知角标管理 — 用法同 VVONotificationBadgeStore
 */
internal class CoolapkNotificationBadgeStore(
    private val loader: CoolapkLoader,
    ...
    private fun effectiveCount(filter: NotificationFilter): Int =
        localOverrides[filter] ?: serverCounts[filter] ?: 0
